...
function main(arg)
    ...
    if arg == "downloadNew" then
        ...
        shell.run("pastebin", "get", "ZEW96K3H", "/tmp/download/init_new");
    ...
    elseif arg == "install" then
        ...
        shell.run("pastebin","get","40M247Kj", "/tmp/scriptBank");   -- In the future, this script should somehow self-determine which are the scripts this specific turtle archetype needs.
        os.sleep(0);
